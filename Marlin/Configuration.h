...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0, 80.0, 200.0, 282}  // default steps per unit for ultimaker2
...
#define FILAMANT_BOWDEN_LENGTH        650

// Length of the extruder from bowden tube end to nozzle 
#define FILAMENT_EXTRUDER_LENGTH      30
...
#define END_OF_PRINT_RETRACTION 13		// number of mm to retract when printer goes idle
