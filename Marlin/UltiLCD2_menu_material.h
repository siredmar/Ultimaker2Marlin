...
#define FILAMENT_REVERSAL_LENGTH      (FILAMANT_BOWDEN_LENGTH + FILAMENT_EXTRUDER_LENGTH)
#define FILAMENT_REVERSAL_SPEED       100
#define FILAMENT_LONG_MOVE_ACCELERATION 30

#define FILAMENT_FORWARD_LENGTH       (FILAMANT_BOWDEN_LENGTH - FILAMENT_EXTRUDER_LENGTH)
